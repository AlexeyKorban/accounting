...
<script type="text/javascript" src="resources/js/accounting.users.js" defer></script>
...
<div class="jumbotron pt-4">
    <div class="container">
        ...
        <table class="table table-striped" id="dadatable">
            <thead>
            <tr>
            ...
            <c:forEach items="${users}" var="user">
                <jsp:useBean id="user" type="ru.ldwx.accounting.model.User"/>
                <tr>
